...
# Solver options
sopt = {'T' :	5*3600, # end of simulation [s from hr]
...
# ------------------------------------------------------------------------------
simbasename = "microbe_respiration"
observation_filename = [simbasename + '-obs-0.tec']
variable_list = ['Total molasses [M]']
...
regression_result = pf.calc_regression(ts = 0.5,tol = 1.0e-10,results_ode=results_ode, results_pflotran=results_pflotran, ode_plotvars=ode_plotvars, pflo_plotvars=pflo_plotvars, sim=simbasename)
